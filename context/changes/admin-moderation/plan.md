...
- [x] 2.1 Mocked API handler unit tests pass — d76dc63
- [x] 2.2 `npm run lint` passes — d76dc63
- [x] 2.3 `npm run build` passes — d76dc63

#### Manual

- [x] 2.4 Moderation section visible only to admin; queue shows seeded pending entry — d76dc63
- [x] 2.5 Approve updates status and entry becomes visible on public profile — d76dc63
- [x] 2.6 Reject updates status and entry stays hidden from public profile — d76dc63
- [x] 2.7 Non-admin PATCH to admin API is rejected (401/403) — d76dc63

### Phase 3: Decorator-facing status badge

#### Automated

- [x] 3.1 `npm run lint` passes — 28f1745
- [x] 3.2 `npm run build` passes — 28f1745

#### Manual

- [x] 3.3 Badge shows correct state for pending/approved/rejected entries — 28f1745
